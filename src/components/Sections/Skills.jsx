    ...
    <section id="skills" className="py-24 px-6 md:px-20 max-w-[1200px] mx-auto">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
        {profile.skills.map((category, index) => (
          <div key={index} className="bg-[#112240] p-6 rounded-lg hover:-translate-y-2 transition-all duration-300 border border-transparent hover:border-accent/30 group">
